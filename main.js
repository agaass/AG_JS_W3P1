...
var separateTeams = function(teammates) {
...
var looseChange = function(quarters, dimes, nickels, pennies) {
  ...
  return "$" + (quarterSum + dimeSum + nickelSum + pennySum).toFixed(2);
}
looseChange(120, 20, 15, 2);


var looseChange = function(quarters, dimes, nickels, pennies) {
  var quarterSum = quarters * 25;
  var dimeSum = dimes * 10;
  var nickelSum = nickels * 05;
  var pennySum = pennies * 01;
  return "$" + (quarterSum + dimeSum + nickelSum + pennySum) / 100;
}
looseChange(120, 20, 15, 2);
